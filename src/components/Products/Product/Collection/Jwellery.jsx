...
const Jwellery = (props) => {
  const jwellery = jsonData.filter((cat) => cat.category === "jewelery");
  ...
  return (
    <>
      <Grid item md={12} sx={{ background: "white", mx: 2, mb: 7 }}>
        ...
        >
          Jwellery <sup className={classes.discount}>Min. {Math.floor(Math.random()*50)}% OFF</sup>
          <Button
